const fa = {
  ...
  hero: {
    ...
    description:
"ما آریسکسیم؛ یه تیم دو نفره که از علاقه‌مون به برنامه‌نویسی و ساختن شروع کردیم. اینجا پروژه‌هایی که می‌سازیم و مسیری که داریم طی می‌کنیم رو باهات به اشتراک می‌ذاریم.",
